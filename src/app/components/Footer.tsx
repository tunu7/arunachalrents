...
export default function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 w-full bg-white shadow-md p-2 flex justify-around items-center border-t">
      <Link href="/" className="p-2 rounded-lg hover:bg-gray-200 transition">
